...
\usetikzlibrary{arrows, angles, babel, quotes, patterns, patterns.meta, shapes.geometric}

\usepackage{float} % костыль, но сорри
...
\fancyhead[L]{\href{https://t.me/argumentofperiapsis}{\small \TeXподдержка}}
...
\begin{problem}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[->,>=stealth,shorten >=1pt,auto,
            ...
            main node/.style={draw,font=\sffamily\small\bfseries},
            edge from parent/.style={draw,->},
            level distance=2cm,
            level/.style={sibling distance=6cm/#1},
            child anchor=north, scale=0.75]

            \node[main node, ellipse] {-10}
                child { node[main node, circle] {9} }
                child {
                    node[main node, circle] {20}
                        child {
                            node[main node, circle] {-3}
                            child {
                                node[main node, circle] {5}
                                child { node[main node, circle] {-2} }
                                child[missing]
                            }
                            child { node[main node, circle] {-4} }
                        }
                        child {
                            node[main node, circle] {8}
                            child[missing]
                            child { node[main node, circle] {-2} }
                        }
                };
...
\begin{problem}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[->,>=stealth,shorten >=1pt,auto,thick]
            ...
            \draw (6, 0) rectangle +(2, 6);
            \draw (8, 0) rectangle +(2, 2);
            \draw (10, 0) rectangle +(2, 3);

            \node[font=\sffamily\large\bfseries, anchor=south] at (1, 2) {2};
            \node[font=\sffamily\large\bfseries, anchor=south] at (3, 1) {1};
            \node[font=\sffamily\large\bfseries, anchor=south] at (5, 5) {5};
            \node[font=\sffamily\large\bfseries, anchor=south] at (7, 6) {6};
            \node[font=\sffamily\large\bfseries, anchor=south] at (9, 2) {2};
            \node[font=\sffamily\large\bfseries, anchor=south] at (11, 3) {3};

            \path[pattern={Lines[angle=45, distance={3mm/sqrt(2)}]}] (4, 0) rectangle +(4, 5);
        \end{tikzpicture}
...
\begin{problem}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[->,>=stealth,shorten >=1pt,auto,scale=0.5,
        ...
        \begin{tikzpicture}[->,>=stealth,shorten >=1pt,auto,scale=0.5,
            ...
            \begin{scope}
                \node[main node] (1) [circle, draw] {1};
                \node[main node] (3) [right of=1] {3};
                \node[main node] (2) [right of=3] {2};
                \node[main node] (null) [right of=2, color=red, ellipse] {null};
            \end{scope}
        ...
        \begin{tikzpicture}[->,>=stealth,shorten >=1pt,auto,scale=0.5,
            ...
            \begin{scope}
                \node[main node] (1) [circle, draw] {1};
                \node[main node] (3) [above right of=1] [circle, draw] {3};
                \node[main node] (4) [below right of=3]  [circle, draw] {4};
                \node[main node] (2) [below left of=4]  [circle, draw] {2};
            \end{scope}
...
\begin{problem}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[auto, scale=1, very thick]
            \tkzDefPoints{0/0/A,4/-2/D};
            \tkzDefPointBy[rotation=center D angle -108](A);
            \tkzGetPoint{C};
            \tkzDefPointBy[rotation=center C angle -48](D);
            \tkzGetPoint{B};

            % \fill[fill=orange, fill opacity=0.2] (A) -- (B) -- (C) -- (D) -- cycle;

            \tkzMarkSegments[pos=0.5, mark=|](B,C C,D A,D);
            \tkzFillAngles[mark=none, size=0.5, fill=white](A,B,C B,C,D C,D,A);

            \tkzMarkAngle[arc=l, mark=none, size=0.5, draw=blue](A,B,C);
            \tkzMarkAngle[arc=l, mark=none, size=0.5, draw=orange](B,C,D);
            \tkzMarkAngle[arc=l, mark=none, size=0.55, draw=orange](B,C,D);
            \tkzMarkAngle[arc=l, mark=none, size=0.5, draw=orange](C,D,A);

            \tkzDrawPoints(A, B, C, D);
            \tkzLabelPoints[below](A, D);
            \tkzLabelPoints[above](B, C);
            \tkzLabelAngle[dist=0.85](A,B,C){\small $\alpha$};
            \tkzLabelAngle(B,C,D){\small $48^{\circ}$};
            \tkzLabelAngle(C,D,A){\small $108^{\circ}$};
...
\begin{problem}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[auto, scale=0.75, very thick]
            \tkzDefPoints{0/0/A,0/4/B};
            \tkzDefPointBy[rotation=center B angle 140](A);
            \tkzGetPoint{C'};
            \tkzDefPointBy[homothety=center B ratio 1.8](C');
            \tkzGetPoint{C};
            ...
            \tkzMarkSegments[pos=0.5, mark=|](B,C C,D);
            \tkzFillAngles[mark=none, size=0.5, fill=white](C,A,B A,C,D);
            \tkzFillAngle[mark=none, size=0.75, fill=white](D,A,C);
            \tkzFillAngle[mark=none, size=1.5, fill=white](B,C,A);

            \tkzMarkAngle[arc=l, mark=none, size=0.5 * 2, draw=blue](C,A,B);
            \tkzMarkAngle[arc=l, mark=none, size=0.5 * 2, draw=blue](A,C,D);
            \tkzMarkAngle[arc=l, mark=none, size=1.5 * 2, draw=orange](B,C,A);
            \tkzMarkAngle[arc=l, mark=none, size=1.55 * 2, draw=orange](B,C,A);
            \tkzMarkAngle[arc=l, mark=none, size=1.6 * 2, draw=orange](B,C,A);
            \tkzMarkAngle[arc=l, mark=none, size=0.75 * 2, draw=orange](D,A,C);
            \tkzMarkAngle[arc=l, mark=none, size=0.8 * 2, draw=orange](D,A,C);

            \tkzDrawPoints(A, B, C, D);
            \tkzLabelPoints[below](A, D);
            \tkzLabelPoints[above](B, C);
            \tkzLabelAngle[dist=1.15 * 1.75](C,A,B){\small $3\alpha$};
            \tkzLabelAngle[dist=1.15 * 1.75](A,C,D){\small $3\alpha$};
            \tkzLabelAngle[dist=1.25 * 1.75](D,A,C){\small $5\alpha$};
            \tkzLabelAngle[dist=4](B,C,A){\small $\alpha$};
