...
\usetikzlibrary{arrows, angles, babel, quotes, patterns, patterns.meta, positioning, shapes.geometric}
...
\begin{problem}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[auto, scale=0.75, very thick]
            ...
            \tkzLabelPoints[below](A, D);
            \tkzLabelPoints[above](B, C);
            \tkzLabelAngle[dist=1.15 * 1.75](C,A,B){\small $3x$};
            \tkzLabelAngle[dist=1.15 * 1.75](A,C,D){\small $3x$};
            \tkzLabelAngle[dist=1.25 * 1.75](D,A,C){\small $5x$};
            \tkzLabelAngle[dist=4](B,C,A){\small $x$};
